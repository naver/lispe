...
Element* eval_body_as_argument_min(LispE* lisp, Element* function, unsigned long arity) {
   ...
   if (function->isList()) {
      ...
      case l_deflib:
         ...
         break;
            default:
               return new Error("Error: wrong function call");
      }
...
Element* List_emptylist_eval::_eval(LispE* lisp) {
    return emptylist_;
}

Element* List_quote_eval::_eval(LispE* lisp) {
    return liste[1];
}

Element* List_and_eval::_eval(LispE* lisp) {
   bool test = true;

   lisp->checkState(this);
   Element* element;
   for (long i = 1; i < listsize && thrown_error == NULL && test; i++) {
   ...
   if (thrown_error) {
      return lisp->check_error(this, thrown_error, line, fileidx);
   }
   lisp->resetStack();
...
Element* List_atomp_eval::_eval(LispE* lisp) {
...
Element* List_block_eval::_eval(LispE* lisp) {
   ...
   for (long i = 1; i < listsize && thrown_error == NULL && element->type != l_return; i++) {
      element->release();
      element = liste[i]->eval(lisp);
   }
   if (thrown_error) {
...
Element* List_emptyp_eval::_eval(LispE* lisp) {
...
Element* List_cadr_eval::_eval(LispE* lisp) {
...
Element* List_car_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   Element* car_result;
...
Element* List_cdr_eval::_eval(LispE* lisp) {
...
Element* List_check_eval::_eval(LispE* lisp) {
   ...
   _releasing(element);
   liste.back()->setterminal(terminal);
   for (long i = 2; i < listsize && thrown_error == NULL && element->type != l_return; i++) {
      element->release();
      element = liste[i]->eval(lisp);
   }
   if (thrown_error) {
...
Element* List_cond_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   ...
   lisp->checkState(this);
   long szv;
   for (long i = 1; i < listsize && thrown_error == NULL; i++) {
      ...
      if (!second_element->isList() || szv <= 1)
         ...
         return lisp->check_error(this,  new Error(L"Error: in a 'cond' the first element must be a list"), line, fileidx);
      }
...
Element* List_cons_eval::_eval(LispE* lisp) {
...
Element* List_consb_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   if (first_element == emptylist_)
      first_element = null_;
...
Element* List_consp_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_clone_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_cutlist_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
...
Element* List_complex_eval::_eval(LispE* lisp) {
    double d;
...
Element* List_real_eval::_eval(LispE* lisp) {
...
Element* List_imaginary_eval::_eval(LispE* lisp) {
   Element* e = liste[1]->eval(lisp);
   if (e->type == t_complex) {
   ...
   return new Error("Error: expecting a complex value");
}


Element* List_integer_eval::_eval(LispE* lisp) {
...
Element* List_number_eval::_eval(LispE* lisp) {
    Element* value = liste[1]->eval(lisp);
...
Element* List_string_eval::_eval(LispE* lisp) {
    Element* value = liste[1]->eval(lisp);
...
Element* List_if_eval::_eval(LispE* lisp) {
...
Element* List_ife_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   ...
   for (long i = 3; i < listsize && thrown_error == NULL && element->type != l_return; i++) {
      element->release();
      element = liste[i]->eval(lisp);
   }
   if (thrown_error) {
...
Element* List_in_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
...
Element* List_at_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* container = liste[1]->eval(lisp);
   ...
   for (long i = 2; i < listsize && thrown_error == NULL; i++) {
...
Element* List_set_at_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* container = liste[1]->eval(lisp);
   Element* result = container;
   Element* value = null_;
...
Element* List_key_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
   ...
   if (first_element->isDictionary()) {
      if ((listsize % 2 ))
         {
         first_element->release();
         return lisp->check_error(this,  new Error("Error: wrong number of arguments for 'key'"), line, fileidx);
      }
   ...
   switch (first_element->type) {
      case t_dictionary: {
         u_ustring a_key;
         for (long i = first; i < listsize && thrown_error == NULL; i+=2) {
      ...
      case t_dictionaryi: {
         long a_key;
         for (long i = 2; i < listsize && thrown_error == NULL; i+=2) {
...
Element* List_keyi_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
      //We create an empty dictionary
   ...
   if (listsize == 3 && first_element->isDictionary()) {
      if (first_element->type != t_dictionaryi)
         {
         first_element->release();
         return lisp->check_error(this,  new Error("Error: wrong dictionary type for 'keyi'"), line, fileidx);
      }
      evalAsInteger(2, lisp, a_key);
      second_element = first_element->protected_index(lisp, a_key);
      first_element->release();
   ...
   if (first_element->isDictionary()) {
      ...
      if ((listsize % 2 ))
         {
         first_element->release();
         return lisp->check_error(this,  new Error("Error: wrong number of arguments for 'keyi'"), line, fileidx);
      }
      first = 2;
      // It is out of question to manipulate a dictionary declared in the code
      first_element = first_element->duplicate_constant(lisp);
...
Element* List_keyn_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
      //We create an empty dictionary
   ...
   if (listsize == 3 && first_element->isDictionary()) {
      if (first_element->type != t_dictionaryn)
         {
         first_element->release();
         return lisp->check_error(this,  new Error("Error: wrong dictionary type for 'keyn'"), line, fileidx);
      }
      evalAsNumber(2, lisp, a_key);
      second_element = first_element->protected_index(lisp, a_key);
      first_element->release();
   ...
   if (first_element->isDictionary()) {
      ...
      if ((listsize % 2 ))
         {
         first_element->release();
         return lisp->check_error(this,  new Error("Error: wrong number of arguments for 'keyn'"), line, fileidx);
      }
      first = 2;
      // It is out of question to manipulate a dictionary declared in the code
      first_element = first_element->duplicate_constant(lisp);
...
Element* List_dictionary_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
      //We create an empty dictionary
      return lisp->provideDictionary();
   ...
   if (!(listsize % 2 ))
      return new Error("Error: wrong number of arguments for 'dictionary'");
   ...
   u_ustring a_key;
   //We store values
   for (long i = 1; i < listsize && thrown_error == NULL; i+=2) {
      element = liste[i]->eval(lisp);
...
Element* List_dictionaryi_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
      //We create an empty dictionary
      return lisp->provideDictionary_i();
...
Element* List_dictionaryn_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1) {
      //We create an empty dictionary
      return lisp->provideDictionary_n();
...
Element* List_list_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1)
      return emptylist_;
...
Element* List_loop_eval::_eval(LispE* lisp) {
   int16_t label = liste[1]->label();
   if (label == v_null)
      return new Error(L"Error: Missing label for 'loop'");
...
Element* List_loopcount_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   long counter;
   int16_t label = 0;
   long first = 2;
   ...
   lisp->checkState(this);
   while (counter > 0) {
      for (long i = first; i < listsize && thrown_error == NULL && result->type != l_return; i++) {
         result->release();
...
Element* List_ncheck_eval::_eval(LispE* lisp) {
...
Element* List_not_eval::_eval(LispE* lisp) {
    Element* first_element = liste[1]->eval(lisp);
...
Element* List_nullp_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_numberp_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_numbers_eval::_eval(LispE* lisp) {
   ...
   for (long e = 1; e < listsz && thrown_error == NULL; e++) {
...
Element* List_integers_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   if (listsz == 1)
...
Element* List_strings_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   if (listsz == 1)
...
Element* List_or_eval::_eval(LispE* lisp) {
   bool test = false;
...
Element* List_pop_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   if (container->isString()) {
      long keyvalue;
...
Element* List_popfirst_eval::_eval(LispE* lisp) {
...
Element* List_poplast_eval::_eval(LispE* lisp) {
...
Element* List_last_eval::_eval(LispE* lisp) {
    Element* container = liste[1]->eval(lisp);
...
Element* List_push_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
...
Element* List_pushtrue_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   container = container->duplicate_constant(lisp);
...
Element* List_pushfirst_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   container = container->duplicate_constant(lisp);
...
Element* List_pushlast_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   container = container->duplicate_constant(lisp);
...
Element* List_stringp_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_switch_eval::_eval(LispE* lisp) {
   List* code = NULL;
   u_ustring key;
   Element* e;
   ...
   if (code == NULL) {
      ...
      msg += U"'";
      {
         return lisp->check_error(this,  new Error(msg), line, fileidx);
      }
   }
...
Element* List_while_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* condition = liste[1]->eval(lisp);
   ...
   lisp->checkState(this);
   while (test) {
      for (long i = 2; i < listsize && thrown_error == NULL && result->type != l_return; i++) {
         _releasing(result);
         result = liste[i]->eval(lisp);
      }
...
Element* List_zerop_eval::_eval(LispE* lisp) {
    long n;
    evalAsInteger(1, lisp, n);
    return booleans_[!n];
}

Element* List_call_lambda::_eval(LispE* lisp) {
   ...
   do {
      if (nbinstructions == 3)
         ...
         element = null_;
         for (i = 2; i < nbinstructions && thrown_error == NULL && element != terminal_ && element->type != l_return; i++) {
            element->release();
...
Element* List_lambda_eval::eval_lambda_min(LispE* lisp) {
   ...
   if (nbinstructions == 3)
      ...
      element = null_;
      for (int16_t i = 2; i < nbinstructions && thrown_error == NULL && element->type != l_return; i++) {
         element->release();
         element = liste[i]->eval(lisp);
      }
   }
...
Element* List_function_eval::_eval(LispE* lisp) {
   //terminal helps detects terminal recursion...
   //A terminal recursion can be processed in a quasi iterative way.
   //When a if or cond is processed, their last element is automatically set to terminal
   //When it corresponds to a function call, then it is processed here
   ...
   do {
      if (nbinstructions == 4)
         ...
         element = null_;
         for (i = 3; i < nbinstructions && thrown_error == NULL && element != terminal_ && element->type != l_return; i++) {
            element->release();
            element = body->liste[i]->eval(lisp);
         }
      }
...
Element* List_library_eval::_eval(LispE* lisp) {
   if (same)
...
Element* List_pattern_eval::_eval(LispE* lisp) {
      ...
      if (ilabel > l_final && element->type != t_data) {
         ...
         if (match != check_ok) {
            ...
            if (match == check_mismatch)
               {
               arguments->release();
               return lisp->check_error(this,  new Error(L"Error: Size mismatch between argument list and data structure definition"), line, fileidx);
            }
            else {
               ...
               {
                  arguments->release();
                  return lisp->check_error(this,  new Error(message.str()), line, fileidx);
               }
            }
         }
      }
   ...
   do {
      if (nbarguments == 4)
         ...
         element = null_;
         for (i = 3; i < nbarguments && thrown_error == NULL && element != terminal_ && element->type != l_return; i++) {
            element->release();
...
Element* List_maplist_lambda_eval::_eval(LispE* lisp) {
   Element* element = null_;
   Element* op = liste[1];
...
Element* List_maplist_eval::_eval(LispE* lisp) {
...
Element* List_filterlist_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   //Operation is: (// operation l1)
   ...
   if (op->isLambda()) {
      if (!op->index(1)->size())
         ...
         element->release();
         result->release();
         return lisp->check_error(this,  new Error("Error: Wrong number of arguments"), line, fileidx);
      }
      ...
      if (label < l_final)
         ...
         element->release();
         result->release();
         return lisp->check_error(this,  new Error("Error: Wrong argument"), line, fileidx);
      }
      iter = element->begin_iter();
      Element* nxt = element->next_iter_exchange(lisp, iter);
      //if there is already a variable with this name on the stack
...
Element* List_takelist_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   //Operation is: (// operation l1)
...
Element* List_droplist_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   //Operation is: (// operation l1)
...
Element* List_eq_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   bool test;
   ...
   for (long i = 3; i < listsize && thrown_error == NULL && test; i++) {
...
Element* List_neq_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   bool test;
...
Element* List_greater_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Integers* res = NULL;
   Element* test;
   Element* second_element;
   ...
   test = true_;
   for (long i = 2; i < listsize && thrown_error == NULL && test->Boolean() ; i++) {
      second_element = liste[i]->eval(lisp);
      test = first_element->more(lisp, second_element);
      first_element->release();
...
Element* List_greaterorequal_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   Integers* res = NULL;
   Element* test;
...
Element* List_lower_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   Integers* res = NULL;
   Element* test;
...
Element* List_lowerorequal_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   Integers* res = NULL;
   Element* test;
...
Element* List_stringf_eval::_eval(LispE* lisp) {
   char* buffer = NULL;
   ...
   case t_number:
      ...
      break;
         default:
            e->release();
         return new Error("Error: the first argument should be a number");
   }
...
Element* List_iota_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* res = null_;
   Element* e = null_;
   Element* sub;
...
Element* List_iota0_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* res = null_;
   Element* e = null_;
   Element* sub;
...
Element* List_innerproduct_eval::_eval(LispE* lisp) {
   ...
   if (!t1 || !t2 || t1 != t2)
      ...
      op1->release();
      op2->release();
      return lisp->check_error(this,  new Error("Error: arguments for '.' must be compatible lists or matrices"), line, fileidx);
   }
   ...
   if (t1 == 2) {
      if (sx_1 != sx_2)
         ...
         op1->release();
         op2->release();
         return lisp->check_error(this,  new Error("Error: lists should have the same size for '.'"), line, fileidx);
      }
   ...
   if (sy_1 != sx_2)
      ...
      op1->release();
      op2->release();
      return lisp->check_error(this,  new Error("Error: incompatible matrices"), line, fileidx);
   }
...
Element* List_outerproduct_eval::_eval(LispE* lisp) {
   ...
   if (!l1->isList() || !l2->isList())
      ...
      l2->release();
      res->release();
      return lisp->check_error(this,  new Error("Error: arguments for '°' are lists"), line, fileidx);
   }
...
Element* List_rank_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
...
Element* List_irank_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   long listsz = liste.size();
   ...
   if (shape.size() < r->positions.size())
      ...
      element->release();
      e->release();
      return lisp->check_error(this,  new Error("Error: cannot loop with 'irank' with these indexes"), line, fileidx);
   }
...
Element* List_reduce_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   //Operation is: (// operation l1)
   ...
   if (!l1->isList())
      ...
      l1->release();
      op->release();
      return lisp->check_error(this,  new Error("Error: argument for 'reduce' should be a list"), line, fileidx);
   }
...
Element* List_backreduce_eval::_eval(LispE* lisp) {
   long listsz = liste.size();
   //Operation is: (-// operation l1)
   ...
   if (!l1->isList())
      ...
      l1->release();
      op->release();
      return lisp->check_error(this,  new Error("Error: argument for 'backreduce' should be a list"), line, fileidx);
   }
...
Element* List_concatenate_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* res = null_;
   bool sb = lisp->set_true_as_one();
   ...
   switch (first_element->type) {
      case t_matrix: {
         ...
         if (sz1.size() < sz2.size())
            ...
            second_element->release();
            first_element->release();
            return lisp->check_error(this,  new Error("Error: Dimension error"), line, fileidx);
         }
...
Element* List_member_eval::_eval(LispE* lisp) {
   ...
   if (!element->isList())
      ...
      element->release();
      the_set->release();
      return lisp->check_error(this,  new Error("Error: expecting a list as first element"), line, fileidx);
   }
...
Element* List_rho_eval::_eval(LispE* lisp) {
   long listsize =  size();
   ...
   if (listsize == 3) {
      ...
      if (!e->isList())
         ...
         res->release();
         lisp->reset_to_true(sb);
         return lisp->check_error(this,  new Error("Error: Second argument should be a list"), line, fileidx);
      }
   ...
   if (listsize == 4) {
      ...
      if (!e->isList())
         ...
         res->release();
         lisp->reset_to_true(sb);
         return lisp->check_error(this,  new Error("Error: third argument should be a list"), line, fileidx);
      }
   ...
   if (!e->isList())
      ...
      res->release();
      lisp->reset_to_true(sb);
      return lisp->check_error(this,  new Error("Error: last argument should be a list"), line, fileidx);
   }
   switch (e->type) {
      case t_shorts:
      case t_floats:
...
Element* List_equalonezero_eval::_eval(LispE* lisp) {
   Element* l1 = liste[1]->eval(lisp);
...
Element* List_scan_eval::_eval(LispE* lisp) {
   //Operation is: (\\ operation l1 l2)
   ...
   if (!l1->isList()) {
      l1->release();
      return new Error("Error: argument for 'scan' should be a list");
   }
   Element* op = null_;
   long sz = 0;
...
Element* List_backscan_eval::_eval(LispE* lisp) {
   //Operation is: (-\\ operation l1 l2)
   Element* l1 = liste[2]->eval(lisp);
   if (!l1->isList()) {
      l1->release();
      return new Error("Error: argument for 'backscan' should be a list");
   }
...
Element* List_flip_eval::_eval(LispE* lisp) {
   Element* first_element = liste[0];
   ...
   switch (first_element->type) {
      ...
      default:
         ...
         return lisp->check_error(this,  new Error("Error: cannot flip this element"), line, fileidx);
      }
   }
...
Element* List_equal_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   char test = true;
...
Element* List_different_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   char test;
...
Element* List_extract_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   Element* value;
...
Element* List_set_range_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   int16_t label = liste[1]->label();
   Element* value;
...
Element* List_flatten_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_at_shape_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   ...
   if (!shape->isList() || !shape_size || shape_size < instruction_size - 3)
      ...
      container->release();
      result->release();
      return lisp->check_error(this,  new Error("Error: Expecting a list with enough values to match the indexes as second argument"), line, fileidx);
   }
   ...
   for (i = instruction_size - 1; i >= 3; i--) {
      ...
      if (index < 0) {
         ...
         if (index >= begin)
            ...
            container->release();
            result->release();
            return lisp->check_error(this,  new Error("Error: index mismatch with shape"), line, fileidx);
         }
      }
      idx += index*cumul;
      cumul *= begin;
   ...
   if (index < 0) {
      ...
      if (shape_size == instruction_size) {
         if (idx >= container->size())
            ...
            container->release();
            result->release();
            return lisp->check_error(this,  new Error("Error: Index out of bound"), line, fileidx);
         }
...
Element* List_set_shape_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   ...
   for (i = instruction_size - 2; i >= 3; i--) {
      ...
      if (index < 0)
         ...
         value->release();
         container->release();
         return lisp->check_error(this,  new Error("Error: cannot modify this value"), line, fileidx);
      }
   ...
   if (shape_size == instruction_size) {
      ...
      if (cumul > value->size())
         ...
         value->release();
         container->release();
         return lisp->check_error(this,  new Error("Error: cannot store this value in this container"), line, fileidx);
      }
      cumul += idx;
      for (i = idx; i < cumul; i++) {
...
Element* List_infix_eval::_eval(LispE* lisp) {
   ...
   bool modified = false;
   for (ival = 0; ival < listsize && thrown_error == NULL; ival++) {
      eprec = e;
...
Element* List_insert_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
...
Element* List_join_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   Element* second_element;
...
Element* List_keys_eval::_eval(LispE* lisp) {
   Element* dictionary = liste[1]->eval(lisp);
   if (!dictionary->isDictionary()) {
      dictionary->release();
      return new Error(L"Error: the first argument must be a dictionary");
   }
...
Element* List_label_eval::_eval(LispE* lisp) {
   int16_t label = liste[1]->label();
   if (label == v_null)
      return new Error(L"Error: Missing label for 'label'");
...
Element* List_zip_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   ...
   for (i = 1; i < listsize && thrown_error == NULL; i++) {
      ...
      if (!container->isList())
         ...
         result->release();
         lists->release();
         return lisp->check_error(this,  new Error(L"Error: 'zip' only accepts lists as arguments"), line, fileidx);
      }
      if (i == 1)
         szl = container->size();
      else {
         if (szl != container->size())
            ...
            result->release();
            lists->release();
            return lisp->check_error(this,  new Error(L"Error: Lists should all have the same size in 'zip'"), line, fileidx);
         }
      }
      if (container->type == t_llist)
...
Element* List_zipwith_lambda_eval::_eval(LispE* lisp) {
   Element* container = liste[2]->eval(lisp);
   if (!container->isList()) {
      container->release();
      return new Error(L"Error: 'zipwith' only accepts lists as arguments");
   }
   Element* value;
   ...
   for (i = 3; i < listsize && thrown_error == NULL; i++) {
      container = liste[i]->eval(lisp);
      if (container->isList() && szl == container->size()) {
         ...
         lists->release();
         container->decrement();
         return lisp->check_error(this,  new Error(L"Error: 'zipwith' only accepts lists of same size as arguments"), line, fileidx);
      }
   }
...
Element* List_zipwith_eval::_eval(LispE* lisp) {
   Element* container = liste[2]->eval(lisp);
   if (!container->isList()) {
      container->release();
      return new Error(L"Error: 'zipwith' only accepts lists as arguments");
...
Element* List_search_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
...
Element* List_count_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* third_element;
...
Element* List_searchall_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* third_element;
...
Element* List_replaceall_eval::_eval(LispE* lisp) {
...
Element* List_select_eval::_eval(LispE* lisp) {
    long listsize = liste.size();
    Element* second_element = null_;
...
Element* List_replicate_eval::_eval(LispE* lisp) {
    /*
     (replicate nb list)
     */
    long nb;
...
Element* List_reverse_eval::_eval(LispE* lisp) {
   ...
   if (liste.size() == 3) {
      ...
      if (result != true_) {
         ...
         if (axis < 0 || axis >= matrix->shapesize())
            ...
            result->release();
            matrix->release();
            return lisp->check_error(this,  new Error("Error: cannot reverse along this axis"), line, fileidx);
         }
...
Element* List_revertsearch_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* third_element;
...
Element* List_compare_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element;
   Element* test;
...
Element* List_extend_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   if (!container->isList()) {
      container->release();
      return new Error(L"Error: missing list in 'extend'");
   }
...
Element* List_sort_eval::_eval(LispE* lisp) {
   ...
   if (!container->isList())
      ...
      comparator->release();
      container->release();
      return lisp->check_error(this,  new Error(L"Error: the second argument should be a list for 'sort'"), line, fileidx);
   }
         ...
         if (complist->eval(lisp)->Boolean()) {
            {
               ...
               return lisp->check_error(this,  new Error(L"Error: The comparison must be strict for a 'sort': (comp a a) must return 'nil'."), line, fileidx);
            }
         }
...
Element* List_type_eval::_eval(LispE* lisp) {
    Element* element  = liste[1]->eval(lisp);
...
Element* List_rotate_eval::_eval(LispE* lisp) {
    Element* container = liste[1]->eval(lisp);
    Element* value;
...
Element* List_unique_eval::_eval(LispE* lisp) {
    Element* container = liste[1]->eval(lisp);
...
Element* List_values_eval::_eval(LispE* lisp) {
    Element* container = liste[1]->eval(lisp);
...
Element* List_xor_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   ...
   lisp->checkState(this);
   for (long i = 2; i < listsize && thrown_error == NULL && test; i++) {
      element->release();
      element = liste[i]->eval(lisp);
      test = check;
...
#ifdef LISPE_WASM
Element* List_setq_eval::_eval(LispE* lisp) {
    Element* e = liste[2]->eval(lisp);
    if (thrown_error)
        return e;
...
Element* List_let_eval::_eval(LispE* lisp) {
    Element* e = liste[2]->eval(lisp);
    if (thrown_error)
        return e;
    lisp->storing_variable(e, liste[1]->label());
...
#endif
Element* List_set_const_eval::_eval(LispE* lisp) {
    int16_t label = liste[1]->label();
    Element* element = liste[2]->eval(lisp);
...
Element* List_setg_eval::_eval(LispE* lisp) {
    int16_t label = liste[1]->label();
    Element* element = liste[2]->eval(lisp);
...
Element* List_seth_eval::_eval(LispE* lisp) {
   if (lisp->check_thread_stack) {
      Element* element = liste[2]->eval(lisp);
      lisp->delegation->thread_stack.storing_variable(element->duplicate_constant(lisp), liste[1]->label());
      return True_;
   }
   return new Error("Error: this instruction can only be used in a 'threadspace' block");
}


Element* List_print_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* element = null_;
...
Element* List_printerr_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* element;
...
Element* List_printerrln_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* element;
...
Element* List_println_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* element;
   string val;
...
Element* List_set_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
...
Element* List_sets_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
   ...
   values->release();
   for (long e = 2; e < listsz && thrown_error == NULL; e++) {
      values = liste[e]->eval(lisp);
      if (values->isSet()) {
         void* iter = values->begin_iter();
         Element* nxt = values->next_iter_exchange(lisp, iter);
...
Element* List_seti_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
...
Element* List_setn_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
...
Element* List_minmax_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   long listsize = liste.size();
...
Element* List_max_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   long listsize = liste.size();
   Element* second_element;
...
#ifdef LISPE_WASM
Element* List_maybe_eval::_eval(LispE* lisp) {
    long listsize = liste.size();
...
#endif
Element* List_min_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   long listsize = liste.size();
   Element* second_element;
...
Element* List_nconc_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1)
      return emptylist_;
   Element* result = null_;
   ...
   if (element->isList())
      ...
      result->release();
      element->release();
      return lisp->check_error(this,  new Error("Error: first element is not a list"), line, fileidx);
   }
   element = emptylist_;
   for (i = 2; i < listsize && thrown_error == NULL; i++) {
      element = liste[i]->eval(lisp);
      if (element->isList()) {
...
Element* List_nconcn_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1)
      return emptylist_;
   Element* result = null_;
...
//--------------------
Element* List_andvalue_eval::_eval(LispE* lisp) {
    Element* second_element = null_;
    bool test = true;
...
Element* List_apply_eval::_eval(LispE* lisp) {
   ...
   if (arguments->type == t_list) {
      if (arguments->status) {
         ...
         if (!arguments->insertion(function, 0))
            ...
            return lisp->check_error(this,  new Error("Error: cannot insert this element in this list"), line, fileidx);
         }
      }
   ...
   if (!arguments->isList())
      ...
      return lisp->check_error(this,  new Error("Error: arguments to 'apply' should be given as a list"), line, fileidx);
   }
   if (use_list)
      call = lisp->provideList();
   else
...
Element* List_atomise_eval::_eval(LispE* lisp) {
    Element* values = liste[1]->eval(lisp);
...
Element* List_converttoatom_eval::_eval(LispE* lisp) {
    u_ustring tampon;
...
Element* List_bodies_eval::_eval(LispE* lisp) {
    Element* function = liste[1]->eval(lisp);
...
#ifdef LISPE_WASM
Element* List_catch_eval::_eval(LispE* lisp) {
    long listsize = liste.size();
    Element* element = null_;
    lisp->checkState(this);
...
#endif
Element* List_cyclicp_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_converttoshort_eval::_eval(LispE* lisp) {
    Element* value = liste[1]->eval(lisp);
...
Element* List_converttofloat_eval::_eval(LispE* lisp) {
    Element* value = liste[1]->eval(lisp);
...
Element* List_elapse_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* second_element = null_;
   double diff = 0;
   ...
   for (long i = 1; i < listsize && thrown_error == NULL && second_element->type != l_return; i++) {
...
Element* List_eval_eval::_eval(LispE* lisp) {
...
Element* List_factorial_eval::_eval(LispE* lisp) {
   ...
   if (e->isList()) {
      ...
      for (long j = 0; j < listsize && thrown_error == NULL; j++) {
         res = 1;
         ...
         if (value < 0)
            ...
            e->release();
            r->release();
            return lisp->check_error(this,  new Error("Error: factorial of a negative number does not exists"), line, fileidx);
         }
         if (value <= 20)
...
Element* List_fappend_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
...
Element* List_fread_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
...
Element* List_fwrite_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   string filename = element->toString(lisp);
   element->release();
...
Element* List_shorts_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
      return new Shorts();
   Shorts* n = new Shorts();
...
Element* List_irange_eval::_eval(LispE* lisp) {
    long sz  = liste.size();
    double init, inc;
...
Element* List_irangein_eval::_eval(LispE* lisp) {
    long sz  = liste.size();
    double init, inc;
    evalAsNumber(1, lisp, init);
    if (sz == 4) {
...
Element* List_llist_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   if (listsize == 1)
...
Element* List_to_list_eval::_eval(LispE* lisp) {
    Element* values = liste[1]->eval(lisp);
    if (size() == 2) {
...
Element* List_to_llist_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
...
Element* List_lock_eval::_eval(LispE* lisp) {
   u_ustring key;
   ...
   lisp->checkState(this);
   for (long i = 2; i < listsize && thrown_error == NULL && value->type != l_return; i++) {
      value->release();
      value = liste[i]->eval(lisp);
   }
...
Element* List_mloop_eval::_eval(LispE* lisp) {
...
Element* List_lloop_eval::_eval(LispE* lisp) {
   List* values = lisp->provideList();
   Element* e = null_;
   unsigned long sz;
   long var;
...
Element* List_mark_eval::_eval(LispE* lisp) {
   Element* container = liste[1]->eval(lisp);
   bool test;
   if (liste.size() == 2) {
...
Element* List_resetmark_eval::_eval(LispE* lisp) {
    Element* container = liste[1]->eval(lisp);
...
Element* List_tensor_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* e = zero_;
   vecte<long> shape;
   long s;
   ...
   if (sz == 2) {
      ...
      if (!e->isList())
         {
         e->release();
         return lisp->check_error(this,  new Error("Error: The first element should be a list"), line, fileidx);
      }
      if (e->type == t_tensor_float)
         ...
         if (!c->isNumber())
            {
            e->release();
            return lisp->check_error(this,  new Error("Error: this list should contain numbers"), line, fileidx);
         }
      }
      Numbers l;
      e->flatten(lisp,&l);
...
Element* List_tensor_float_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* e = zero_;
   vecte<long> shape;
   long s;
...
Element* List_matrix_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* e = zero_;
   long sx, sy;
   ...
   if (sz == 2) {
      ...
      if (!e->isList() || !e->index(0)->isList() || !e->index(0)->index(0)->isNumber())
         {
         e->release();
         return lisp->check_error(this,  new Error("Error: Cannot initialize a matrix with this value"), line, fileidx);
      }
      long size_x = e->size();
...
Element* List_matrix_float_eval::_eval(LispE* lisp) {
   long sz = size();
   Element* e = zero_;
   long sx, sy;
...
Element* List_floats_eval::_eval(LispE* lisp) {
   long listsz = size();
   if (listsz == 1)
...
Element* List_pipe_eval::_eval(LispE* lisp) {
...
Element* List_prettify_eval::_eval(LispE* lisp) {
    Element* first_element = liste[1]->eval(lisp);
    long mx = 50;
    if (liste.size() == 3)
...
Element* List_range_eval::_eval(LispE* lisp) {
...
Element* List_rangein_eval::_eval(LispE* lisp) {
    Element* e1 = liste[1]->eval(lisp);
    Element* e2 = liste[2]->eval(lisp);
    Element* e3 = liste[3]->eval(lisp);
...
Element* List_sign_eval::_eval(LispE* lisp) {
    return liste[1]->eval(lisp)->invert_sign(lisp);
}

Element* List_size_eval::_eval(LispE* lisp) {
    Element* element = liste[1]->eval(lisp);
...
Element* List_signp_eval::_eval(LispE* lisp) {
    double v = 0;
...
Element* List_sleep_eval::_eval(LispE* lisp) {
    long tm;
...
Element* List_space_eval::_eval(LispE* lisp) {
...
Element* List_sum_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   switch (first_element->type) {
      case t_floats: {
      ...
      case t_list: {
         ...
         for (long i = 0; i < listsize && thrown_error == NULL; i++) {
      ...
      default:
         first_element->release();
      return new Error("Error: expecting a container as argument");
   }
}


Element* List_product_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   switch (first_element->type) {
      case t_floats: {
      ...
      case t_list: {
         ...
         List* lst = (List*)first_element;
         long listsize = lst->size();
         for (long i = 0; i < listsize && thrown_error == NULL && v; i++)
         v *= lst->liste[i]->checkNumber(lisp);
         first_element->release();
         return lisp->provideNumber(v);
      }
...
Element* List_transpose_eval::_eval(LispE* lisp) {
    Element* matrix = liste[1]->eval(lisp);
...
Element* List_heap_eval::_eval(LispE* lisp) {
   long listsize = liste.size();
   Element* oper = null_;
   List* compare = NULL;
   Heap* tas = NULL;
...
Element* List_trigger_eval::_eval(LispE* lisp) {
    u_ustring key;
    evalAsUString(1, lisp, key);
    return booleans_[lisp->delegation->trigger(key)];
}

Element* List_wait_eval::_eval(LispE* lisp) {
    //We wait for all threads to be finished
    while (lisp->nbjoined) {}
    return True_;
}

Element* List_waiton_eval::_eval(LispE* lisp) {
    u_ustring key;
    evalAsUString(1, lisp, key);
...
Element* List_solve_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   Element* Y;
   Element* res;
   ...
   if (element->type != t_matrix || Y->type != t_matrix)
      {
      element->release();
      return lisp->check_error(this,  new Error("Error: solve can only be applied to matrices"), line, fileidx);
   }
...
Element* List_determinant_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   if (element->type != t_matrix) {
      element->release();
      return new Error("Error: We can only compute the determinant of a matrix");
   }
   double det = 0;
...
Element* List_ludcmp_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   if (element->type != t_matrix) {
      element->release();
      return new Error("Error: the first element should be a matrix");
   }
...
Element* List_lubksb_eval::_eval(LispE* lisp) {
   Element* element = null_;
   Element* idxs = null_;
   Element* Y = NULL;
   ...
   if (element->type != t_matrix)
      ...
      return lisp->check_error(this,  new Error("Error: the first element should be a matrix"), line, fileidx);
   }
   ...
   if (idxs->type != t_integers)
      ...
      return lisp->check_error(this,  new Error("Error: the second element should be an integers_ (a list of integers)"), line, fileidx);
   }
   if (liste.size() == 4) {
      Y = liste[3]->eval(lisp);
      if (Y->type != t_matrix)
         ...
         return lisp->check_error(this,  new Error("Error: the last element should be a matrix"), line, fileidx);
      }
   }
...
Element* List_listand_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
...
Element* List_listor_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* result = first_element;
   long listsize = liste.size();
...
Element* List_listxor_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   Element* second_element = null_;
   Element* result = first_element;
   long listsize = liste.size();
...
Element* List_mod_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   ...
   if (listsize == 2) {
      if (!first_element->isList())
         ...
         if (first_element != second_element)
            second_element->release();
         first_element->release();
         return lisp->check_error(this,  new Error("Error: cannot apply '%' to one element"), line, fileidx);
      }
      lst = first_element;
      switch (lst->type) {
         case t_strings:
            ...
            if (first_element != second_element)
               second_element->release();
            first_element->release();
            return lisp->check_error(this,  new Error("Error: cannot apply '%' to a string"), line, fileidx);
         }
         case t_floats:
         case t_shorts:
         case t_integers:
...
Element* List_leftshift_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   int16_t listsize = liste.size();
   Element* lst = this;
   Element* second_element = null_;
...
Element* List_rightshift_eval::_eval(LispE* lisp) {
   Element* first_element = liste[1]->eval(lisp);
   int16_t listsize = liste.size();
   Element* lst = this;
   Element* second_element = null_;
...
Element* List_invert_eval::_eval(LispE* lisp) {
   Element* element = liste[1]->eval(lisp);
   if (element->type != t_matrix) {
      element->release();
      return new Error("Error: 'invert' can only be applied to matrices");
   }
   Element* Y;
   Element* res;
