...
(defun transforme(fonc fichier)
    ...
    (lloop (atry acatch) tries catches
        ...
        (while (in ntry "throw ")
            ...
            (check (in acatch "return lisp->check_error(this, err, idxinfo);")
        ...
        (if (in acatch "return lisp->check_error(this, err, idxinfo);")
        ...
        (setq fonc (replace fonc "return lisp->check_error(this, err, -1);" "return lisp->check_error(this, thrown_error, -1);"))
